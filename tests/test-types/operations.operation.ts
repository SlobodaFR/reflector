...
export class Operation {
    ...
    constructor({ operationIdentifier, version, steps }: { operationIdentifier: Identifier, version: Version, steps: OperationStep[] }) {
        this._operationIdentifier = operationIdentifier;
        this._version = version;
        this._steps = steps;
    }

    public static create({ operationIdentifier, version, steps }: { operationIdentifier: Identifier, version: Version, steps: OperationStep[] }): Operation {
